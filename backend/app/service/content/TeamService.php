...
final class TeamService
{
    ...
    public function create(array $input, ?array $operator): array
    {
        ...
        $this->operationLogService->recordCurrentAction('team', 'team.create', 'team_member', $record, 'team member created');
    ...
    public function update(int $id, array $input, ?array $operator): array
    {
        ...
        $this->operationLogService->recordCurrentAction('team', 'team.update', 'team_member', $updated, 'team member updated');
    ...
    public function publish(int $id, string $publishStatus, ?array $operator): array
    {
        ...
        $this->operationLogService->recordCurrentAction('team', 'team.publish', 'team_member', $updated, 'team member publish status updated');
    ...
    public function remove(int $id, ?array $operator): array
    {
        ...
        $this->operationLogService->recordCurrentAction('team', 'team.delete', 'team_member', $deleted, 'team member deleted');
    ...
    public function batchPublish(array $ids, string $publishStatus, ?array $operator): array
    {
        ...
        $this->operationLogService->recordCurrentAction('team', 'team.batch_publish', 'team_member', ['ids' => $ids, 'publish_status' => $publishStatus, 'count' => $count], 'team members batch publish updated');
    ...
    public function batchSort(array $sortItems): array
    {
        ...
        $this->operationLogService->recordCurrentAction('team', 'team.batch_sort', 'team_member', ['items' => $normalized, 'count' => $count], 'team members batch sort updated');
