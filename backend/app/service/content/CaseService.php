...
final class CaseService
{
    ...
    public function create(array $input, ?array $operator): array
    {
        ...
        $this->contentWorkflowService->touchDraft(self::ENTITY_TYPE, $record, $operator, 'case created');
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'case.create', self::ENTITY_TYPE, $record, 'case created');
    ...
    public function update(int $id, array $input, ?array $operator): array
    {
        ...
        $this->contentWorkflowService->touchDraft(self::ENTITY_TYPE, $updated, $operator, 'case draft updated');
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'case.update', self::ENTITY_TYPE, $updated, 'case updated');
    ...
    public function publish(int $id, string $publishStatus, ?array $operator): array
    {
        ...
        if ($publishStatus === 'published') {
            ...
            $this->contentWorkflowService->touchDraft(self::ENTITY_TYPE, $updated, $operator, 'case publish status updated');
        }
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'case.publish', self::ENTITY_TYPE, $updated, 'case publish status updated');
    ...
    public function batchPublish(array|string $ids, string $publishStatus, ?array $operator): array
    {
        ...
        foreach ($normalizedIds as $id) {
            ...
            if ($publishStatus === 'published') {
                ...
                $this->contentWorkflowService->touchDraft(self::ENTITY_TYPE, $updated, $operator, 'case batch publish status updated');
            }
        ...
        $this->operationLogService->recordCurrentAction(
            ...
            'case batch publish status updated'
        );
    ...
    public function restoreLive(int $id, ?array $operator): array
    {
        ...
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'case.restore_live', self::ENTITY_TYPE, $restored, 'case restored from live');
    ...
    public function remove(int $id, ?array $operator): array
    {
        ...
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'case.delete', self::ENTITY_TYPE, $deleted, 'case deleted');
    ...
    public function createCategory(array $input): array
    {
        ...
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'case.category.create', 'case_category', $record, 'case category created');
    ...
    public function updateCategory(int $id, array $input): array
    {
        ...
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'case.category.update', 'case_category', $updated, 'case category updated');
    ...
    public function deleteCategory(int $id): array
    {
        ...
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'case.category.delete', 'case_category', $deleted, 'case category deleted');
