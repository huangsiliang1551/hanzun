...
final class ProductService
{
    ...
    public function create(array $input, ?array $operator): array
    {
        ...
        $this->contentWorkflowService->touchDraft('product', $record, $operator, 'product created');
        $this->operationLogService->recordCurrentAction('product', 'product.create', 'product', $record, 'product created');
    ...
    public function update(int $id, array $input, ?array $operator): array
    {
        ...
        $this->contentWorkflowService->touchDraft('product', $updated, $operator, 'product draft updated');
        $this->operationLogService->recordCurrentAction('product', 'product.update', 'product', $updated, 'product updated');
    ...
    public function publish(int $id, string $publishStatus, ?array $operator): array
    {
        ...
        if ($publishStatus === 'published') {
            ...
            $this->contentWorkflowService->touchDraft('product', $updated, $operator, 'product publish status updated');
        }
        $this->operationLogService->recordCurrentAction('product', 'product.publish', 'product', $updated, 'product publish status updated');
    ...
    public function batchPublish(array|string $ids, string $publishStatus, ?array $operator): array
    {
        ...
        foreach ($normalizedIds as $id) {
            ...
            if ($publishStatus === 'published') {
                ...
                $this->contentWorkflowService->touchDraft('product', end($updatedItems), $operator, 'product batch publish status updated');
            }
        }
        ...
        $this->operationLogService->recordCurrentAction(
            ...
            'product batch publish status updated'
        );
    ...
    public function restoreLive(int $id, ?array $operator): array
    {
        ...
        $this->operationLogService->recordCurrentAction('product', 'product.restore_live', 'product', $restored, 'product restored from live');
    ...
    public function remove(int $id, ?array $operator): array
    {
        ...
        $this->operationLogService->recordCurrentAction('product', 'product.delete', 'product', $deleted, 'product deleted');
    ...
    public function createCategory(array $input): array
    {
        ...
        $this->operationLogService->recordCurrentAction('product', 'product.category.create', 'product_category', $record, 'product category created');
    ...
    public function updateCategory(int $id, array $input): array
    {
        ...
        $this->operationLogService->recordCurrentAction('product', 'product.category.update', 'product_category', $updated, 'product category updated');
    ...
    public function deleteCategory(int $id): array
    {
        ...
        $this->operationLogService->recordCurrentAction('product', 'product.category.delete', 'product_category', $deleted, 'product category deleted');
