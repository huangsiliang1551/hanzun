...
final class NavigationService
{
    ...
    public function createMenu(array $data): array
    {
        ...
        $this->operationLogService->recordCurrentAction('navigation', 'navigation.menu.create', 'navigation_menu', $menu, 'navigation menu created');
    ...
    public function updateMenu(int $id, array $data): array
    {
        ...
        $this->operationLogService->recordCurrentAction('navigation', 'navigation.update', 'navigation_menu', $updated, 'navigation menu updated');
    ...
    public function updateItems(int $menuId, array $items): array
    {
        ...
        $this->operationLogService->recordCurrentAction('navigation', 'navigation.items.update', 'navigation_menu', $updated, 'navigation items updated');
    ...
    public function delete(int $id): void
    {
        ...
        $this->operationLogService->recordCurrentAction('navigation', 'navigation.delete', 'navigation_menu', $deleted, 'navigation menu deleted');
    }
}
