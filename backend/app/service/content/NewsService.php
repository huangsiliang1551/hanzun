...
final class NewsService
{
    ...
    public function create(array $input, ?array $operator): array
    {
        ...
        $this->contentWorkflowService->touchDraft(self::ENTITY_TYPE, $record, $operator, 'news created');
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'news.create', self::ENTITY_TYPE, $record, 'news created');
    ...
    public function update(int $id, array $input, ?array $operator): array
    {
        ...
        $this->contentWorkflowService->touchDraft(self::ENTITY_TYPE, $updated, $operator, 'news draft updated');
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'news.update', self::ENTITY_TYPE, $updated, 'news updated');
    ...
    public function publish(int $id, string $publishStatus, ?array $operator): array
    {
        ...
        if ($publishStatus === 'published') {
            ...
            $this->contentWorkflowService->touchDraft(self::ENTITY_TYPE, $updated, $operator, 'news publish status updated');
        }
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'news.publish', self::ENTITY_TYPE, $updated, 'news publish status updated');
    ...
    public function batchPublish(array|string $ids, string $publishStatus, ?array $operator): array
    {
        ...
        foreach ($normalizedIds as $id) {
            ...
            if ($publishStatus === 'published') {
                ...
                $this->contentWorkflowService->touchDraft(self::ENTITY_TYPE, $updated, $operator, 'news batch publish status updated');
            }
        ...
        $this->operationLogService->recordCurrentAction(
            ...
            'news batch publish status updated'
        );
    ...
    public function restoreLive(int $id, ?array $operator): array
    {
        ...
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'news.restore_live', self::ENTITY_TYPE, $restored, 'news restored from live');
    ...
    public function remove(int $id, ?array $operator): array
    {
        ...
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'news.delete', self::ENTITY_TYPE, $deleted, 'news deleted');
    ...
    public function createCategory(array $input): array
    {
        ...
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'news.category.create', 'news_category', $record, 'news category created');
    ...
    public function updateCategory(int $id, array $input): array
    {
        ...
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'news.category.update', 'news_category', $updated, 'news category updated');
    ...
    public function deleteCategory(int $id): array
    {
        ...
        $this->operationLogService->recordCurrentAction(self::ENTITY_TYPE, 'news.category.delete', 'news_category', $deleted, 'news category deleted');
