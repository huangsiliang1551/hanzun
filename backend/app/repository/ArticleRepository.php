...
final class ArticleRepository
{
    ...
    private function listFromDatabase(PDO $pdo, array $query): array
    {
        ...
        $statement = $pdo->prepare(
            'SELECT a.id, a.category_id, a.content_type, a.slug, a.title_zh, a.country_code, a.case_tags, a.publish_status, a.translation_status, a.seo_status, a.is_home_featured, a.manual_sort, a.publish_time, 0 AS views_count, c.name_zh AS category_name
             FROM articles a
