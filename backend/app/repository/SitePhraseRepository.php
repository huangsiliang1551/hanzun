...
final class SitePhraseRepository
{
    private const DEFAULT_LABELS = [
        ...
        'floating_contact_hint' => '悬浮-打开联系方式提示',
        'floating_menu_title' => '悬浮-智能咨询标题',
        'floating_menu_intro' => '悬浮-智能咨询说明',
        'floating_menu_other' => '悬浮-其他联系方式标题',
        'floating_ai_title' => '悬浮-AI咨询标题',
        'floating_ai_hint' => '悬浮-AI咨询说明',
        'floating_contact_trigger_title' => '悬浮-触发按钮标题',
        'floating_contact_trigger_hint' => '悬浮-触发按钮说明',
        'floating_email' => '悬浮-商务邮箱',
        'floating_email_hint' => '悬浮-商务邮箱提示',
        'floating_phone' => '悬浮-工厂总机',
        'floating_phone_hint' => '悬浮-工厂总机提示',
        'floating_whatsapp' => '悬浮-WhatsApp',
        'floating_whatsapp_hint' => '悬浮-WhatsApp提示',
        'floating_address' => '悬浮-工厂地址',
        'floating_address_hint' => '悬浮-工厂地址提示',
        'back_to_top' => '悬浮-返回顶部',
    ...
    private const DEFAULT_TRANSLATIONS = [
        ...
        'floating_contact' => ['zh' => '联系方式', 'en' => 'Contact'],
        'floating_contact_hint' => ['zh' => '点击打开联系方式', 'en' => 'Tap to open contact options'],
        'floating_menu_title' => ['zh' => '智能咨询', 'en' => 'AI Consult'],
        'floating_menu_intro' => ['zh' => '优先通过 AI 咨询产品、方案与报价，其他联系方式作为补充。', 'en' => 'Start with AI for products, solutions, and quotations. Other contact methods stay available as backup.'],
        'floating_menu_other' => ['zh' => '其他联系方式', 'en' => 'Other contact methods'],
        'floating_ai_title' => ['zh' => 'AI咨询', 'en' => 'AI Consult'],
        'floating_ai_hint' => ['zh' => '产品选型、方案沟通、报价咨询', 'en' => 'Machine matching, solution discussion, and quotations'],
        'floating_contact_trigger_title' => ['zh' => 'AI咨询', 'en' => 'AI Consult'],
        'floating_contact_trigger_hint' => ['zh' => '点击展开联系方式', 'en' => 'Tap to open contact options'],
        'floating_email' => ['zh' => '商务邮箱', 'en' => 'Business Email'],
        'floating_email_hint' => ['zh' => '点击查看邮箱地址', 'en' => 'Show email address'],
        'floating_phone' => ['zh' => '工厂总机', 'en' => 'Factory Line'],
        'floating_phone_hint' => ['zh' => '点击查看联系电话', 'en' => 'Show phone number'],
        'floating_whatsapp' => ['zh' => 'WhatsApp', 'en' => 'WhatsApp'],
        'floating_whatsapp_hint' => ['zh' => '打开 WhatsApp 对话', 'en' => 'Start a quick chat'],
        'floating_address' => ['zh' => '工厂地址', 'en' => 'Factory Address'],
        'floating_address_hint' => ['zh' => '打开联系页面', 'en' => 'Open contact page'],
        'back_to_top' => ['zh' => '顶部', 'en' => 'TOP'],
