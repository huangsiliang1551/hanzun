...
class PreviewController extends BaseAdminController
{
    ...
    public function store(Request $request): array
    {
        ...
        if ($entityType === '' || $payload === null || !is_array($payload)) {
            return $this->error(400, 'invalid params');
        }
        ...
        return $this->success(['token' => $token], [], 'preview generated');
    }
    ...
    public function show(Request $request): array
    {
        ...
        if ($pdo instanceof PDO) {
            ...
            if (is_array($row)) {
                ...
                if (strtotime($expiresAt) < time()) {
                    return $this->error(410, 'preview expired');
                }
        ...
        return $this->error(404, 'preview not found');
    }
