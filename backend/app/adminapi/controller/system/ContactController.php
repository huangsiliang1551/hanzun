...
class ContactController extends BaseAdminController
{
    ...
    public function storeFieldType(Request $request): array
    {
        ...
        return $this->success($result, [], '联系字段类型已创建');
    }
    ...
    public function updateFieldType(Request $request): array
    {
        ...
        return $this->success($result, [], '联系字段类型已更新');
    }
    ...
    public function deleteFieldType(Request $request): array
    {
        ...
        return $this->success($result, [], '联系字段类型已删除');
    }
    ...
    public function store(Request $request): array
    {
        ...
        return $this->success($result, [], '联系信息已创建');
    }
    ...
    public function update(Request $request): array
    {
        ...
        return $this->success($result, [], '联系信息已更新');
    }
    ...
    public function delete(Request $request): array
    {
        ...
        return $this->success($result, [], '联系信息已删除');
    }
}
